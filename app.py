...
<div class="main-header">
    ...
    <p>Tác giả: Nông Đức Thắng - Trường Tiểu học Yên Phong - ĐT: 0829777289</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nông Đức Thắng - Trường Tiểu học Yên Phong - ĐT: 0829777289</div>", unsafe_allow_html=True)
